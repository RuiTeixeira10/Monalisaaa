const musicas = {
    missThing: {
        ...
        autor: "Aerosmith",
        capa: "imagens/I dont want to miss a thing.png",
        categoria: "inglesas",
    ...
    heaven: {
        ...
        traducao: [
            ...
            "E o amor é tudo o que preciso",
            "E encontrei isso no teu coração",
            "Não é difícil ver",
            "Estamos no paraíso",

            "Uma vez na vida encontras alguém",
            "Que vira o teu mundo ao contrário",
            "E te levanta quando estás em baixo",

            "Nada pode mudar o que significas para mim",
            "Há tanto que eu podia dizer",
            "Mas abraça-me agora",
    ...
    iris: {
        ...
        traducao: [
            "E eu desistiria da eternidade só para te tocar",
            "Porque eu sei que tu me sentes de alguma forma",
            "És o mais perto do paraíso que eu alguma vez estarei",
            "E eu não quero ir para casa agora"
        ]
    },

    standByYou: {
        titulo: "I'll Stand By You",
        ...
        traducao: [
            "Oh, porque estás tão triste?",
            "Lágrimas estão nos teus olhos",
            "Vem, aproxima-te de mim agora",
            "Mas não tenhas vergonha de chorar",
            "Deixa-me ver-te através disso",
            "Porque eu também já vi o lado escuro",
            "Quando a noite cai sobre ti",
            "E não sabes o que fazer",
            "Nada que confesses",
            "Poderia fazer-me amar-te menos",
